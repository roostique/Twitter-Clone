...
struct TweetService {
    ...
    func uploadTweet(caption: String, type: PostTweetConfiguration, completion: @escaping(Error?, DatabaseReference) -> Void) {
        ...
        case .tweet:
            ...
            // REF_TWEETS.childByAutoId() Creates tweet unique identifiers in 'tweets' Firebase structure
